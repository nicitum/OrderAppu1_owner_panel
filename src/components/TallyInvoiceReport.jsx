              ...
              {invoices.map((invoice) => (
                <React.Fragment key={invoice.id}>
                  ...
                  >
                    ...
                    <td>{invoice.items?.length || 0}</td>                    <td>
                      ₹{(invoice.items?.reduce((sum, item) => sum + (Number(item.rate || 0) * Number(item.quantity || 0)), 0) || 0).toLocaleString('en-IN', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
                    </td>
                  </tr>
                      ...
                      <td colSpan="5">
                        <div className="invoice-details-container">
                          ...
                          <table className="invoice-items-table">
                            ...
                            <tbody>
                              {invoice.items?.map((item, index) => (                                <tr key={`${invoice.id}-${index}`}>
                                  ...
                                  <td>₹{(Number(item.rate || 0) * Number(item.quantity || 0)).toFixed(2)}</td>
                                </tr>
                              )) || (
                                <tr>
                              ...
                              <tr>
                                ...
                                <td className="total-amount">
                                  ₹{(invoice.items?.reduce((sum, item) => sum + (Number(item.rate || 0) * Number(item.quantity || 0)), 0) || 0).toFixed(2)}
                                </td>
                              </tr>
                            </tfoot>
                          </table>
